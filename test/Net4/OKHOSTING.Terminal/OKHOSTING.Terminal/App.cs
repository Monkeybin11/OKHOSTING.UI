...
using OKHOSTING.Terminal.Model;
using System;
using System.Linq;

namespace OKHOSTING.Terminal
{
    public class App : OKHOSTING.UI.App
    {
        public void Start()
        {
            ...
            var select = new OKHOSTING.ORM.Operations.Select<Pasajero>();
        ...
        {
            var types = typeof(Autobus).Assembly.DefinedTypes.ToList();

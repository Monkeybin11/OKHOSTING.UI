...
namespace OKHOSTING.UI.Xamarin.Forms.Test.Droid
{
    public class IndexController : Controller
    {
        ...
        public override void Start()
        {
            ...
            ILabelButton cmdProgramas = Platform.Current.Create<ILabelButton>();
            ...
            play = Platform.Current.Create<IImageButton>();
            ...
            pause = Platform.Current.Create<IImageButton>();
            ...
            stop = Platform.Current.Create<IImageButton>();

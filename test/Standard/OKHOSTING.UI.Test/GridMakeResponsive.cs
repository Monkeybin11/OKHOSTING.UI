...
namespace OKHOSTING.UI.Test
{
    public class GridMakeResponsive :  Controller
    {
        ...
        protected override void OnStart()
        {
			...
			grid.Layouts[5000] = Core.BaitAndSwitch.Create<IGrid>();
			...
			grid.Layouts[5000].ColumnCount =  13;
			grid.Layouts[5000].RowCount = 6;
			...
			grid.Layouts[5000].SetContent(0, 1, lblTwo);
			...
			grid.Layouts[5000].SetContent(0, 2, txtTwo);
			...
			grid.Layouts[5000].SetContent(0, 3, lblThree);
			...
			grid.Layouts[5000].SetContent(0, 4, txtThree);
			...
			grid.Layouts[5000].SetContent(0, 5, lblFour);
			...
			grid.Layouts[5000].SetContent(0, 6, txtFour);
			...
			grid.Layouts[5000].SetContent(0, 7, lblFive);
			...
			grid.Layouts[5000].SetContent(0, 8, txtFive);
			...
			grid.Layouts[5000].SetContent(0, 9, lblSix);
			...
			grid.Layouts[5000].SetContent(0, 10, txtSix);
			...
			grid.Layouts[5000].SetContent(0, 11, lblSeven);
			...
			grid.Layouts[5000].SetContent(0, 12, txtSeven);
			...
			grid.Layouts[5000].SetContent(1, 1, lblEigth);
			...
			grid.Layouts[5000].SetContent(1, 2, txtEigth);
			...
			grid.Layouts[5000].SetContent(1, 3, lblNine);
			...
			grid.Layouts[5000].SetContent(1, 4, txtNine);
			...
			grid.Layouts[5000].SetContent(1, 5, lblTen);
			...
			grid.Layouts[5000].SetContent(1, 6, txtTen);
			...
			grid.Layouts[5000].SetContent(1, 7, lblEleven);
			...
			grid.Layouts[5000].SetContent(1, 8, txtEleven);
			...
			grid.Layouts[5000].SetContent(1, 9, lblTwelve);
			...
			grid.Layouts[5000].SetContent(1, 10, txtTwelve);
			...
			grid.Layouts[5000].SetContent(1, 11, lblThirteen);
			...
			grid.Layouts[5000].SetContent(1, 12, txtThirteen);
			...
			grid.Layouts[5000].SetContent(2, 1, lblFourteen);
			...
			grid.Layouts[5000].SetContent(2, 2, txtFourteen);
			...
			grid.Layouts[5000].SetContent(2, 3, lblFiveteen);
			...
			grid.Layouts[5000].SetContent(2, 4, txtFiveteen);
			...
			grid.Layouts[5000].SetContent(2, 5, lblSixteen);
			...
			grid.Layouts[5000].SetContent(2, 6, txtSixteen);
			...
			grid.Layouts[5000].SetContent(2, 7, lblSeventeen);
			...
			grid.Layouts[5000].SetContent(2, 8, txtSeventeen);
			...
			grid.Layouts[5000].SetContent(2, 9, lblEigtheen);
			...
			grid.Layouts[5000].SetContent(2, 10, txtEigtheen);
			...
			grid.Layouts[5000].SetContent(2, 11, lblNineteen);
			...
			grid.Layouts[5000].SetContent(2, 12, txtNineteen);
			...
			grid.Layouts[5000].SetContent(3, 1, lblTwenty);
			...
			grid.Layouts[5000].SetContent(3, 2, txtTwenty);
			...
			grid.Layouts[5000].SetContent(3, 3, lblTwentyOne);
			...
			grid.Layouts[5000].SetContent(3, 4, txtTwentyOne);

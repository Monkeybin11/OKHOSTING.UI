...
{
	class TemplateAreas : Controller
	{
		protected override void OnStart()
		{
			...
			lblSeparator.Text = "TemplateAreas*****************************************";
			...
			lblSeparator2.Text = "TemplateAreas Example2*****************************************";
			...
			lblSeparator3.Text = "TemplateAreas Example3*****************************************";
			...
			lblSeparator4.Text = "TemplateAreas Example4*****************************************";
			...
			lblSeparator5.Text = "TemplateAreas Example5*****************************************";
			...
			lblSeparator6.Text = "TemplateAreas Example6*****************************************";
			...
			GridSix.SetContent(0, 1, label002a);
			...
			lblSeparator7.Text = "TemplateAreas Example7*****************************************";
			...
			lblSeparator8.Text = "TemplateAreas Example8*****************************************";
			...
			lblSeparator9.Text = "TemplateAreas Example9*****************************************";
			...
			lblSeparator10.Text = "TemplateAreas Example10*****************************************";

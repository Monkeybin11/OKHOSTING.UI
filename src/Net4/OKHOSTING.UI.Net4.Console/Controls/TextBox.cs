...
namespace OKHOSTING.UI.Net4.Console.Controls
{
	...
	public class TextBox : System.Web.UI.WebControls.TextBox, ITextBox
	{
		...
		/// <summary>
		/// Initializes a new instance of the OKHOSTING.UI.Net4.Console.Controls.TextBox class.
		/// <para xml:alng="es">Inicializa una nueva instacia de la clase OKHOSTING.UI.Net4.Console.Controls.TextBox</para>
		/// </summary>
		public TextBox()
		{

...
namespace OKHOSTING.UI.Net4.Console.Controls.Layout
{
	/// <summary>
	...
	{
		/// <summary>
		/// Initializes a new instance of the OKHOSTING.UI.Net4.Console.Controls.Layout.Stack class.
		/// <para xml:lang="es">Inicializa una nueva instancia de la clase OKHOSTING.UI.Net4.Console.Controls.Layout.Stack</para>
		/// </summary>
		public Stack()
		{
		...
		public class ControlList : IList<IControl>
		{
			...
			/// <summary>
			/// Initializes a new instance of the OKHOSTING.UI.Net4.Console.Controls.Layout.Stack.ControlList class.
			/// <para xml:lang="es">Inicializa una nueva instancia de la clase OKHOSTING.UI.Net4.Console.Controls.Layout.Stack.ControlList</para>
			/// </summary>
			...
			/// <summary>
			/// Gets or sets the OKHOSTING.UI.Net4.Console.Controls.Layout.Stack.ControlList at the specified index.

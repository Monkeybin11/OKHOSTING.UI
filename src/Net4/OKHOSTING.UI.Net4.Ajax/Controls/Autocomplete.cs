...
namespace OKHOSTING.UI.Net4.Ajax.Controls
{
	...
	public class Autocomplete : System.Web.UI.WebControls.Panel, IAutocomplete
	{
		...
		/// <summary>
		/// Initializes a new instance of the OKHOSTING.UI.Net4.Ajax.Controls.Autocomplete class.
		/// <para xml:alng="es">Inicializa una nueva instacia de la clase OKHOSTING.UI.Net4.Ajax.Controls.Autocomplete</para>
		/// </summary>
		public Autocomplete()
		{

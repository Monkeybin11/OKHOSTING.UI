...
namespace OKHOSTING.UI.Net4.WPF.Controls.Layout
{
	public partial class RelativePanel
	{
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.Above"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignBottomWithPanel"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignBottomWith"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignHorizontalCenterWithPanel"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignHorizontalCenterWith"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignLeftWithPanel"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignLeftWith"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignRightWithPanel"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignRightWith"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignTopWithPanel"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignTopWith"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignVerticalCenterWithPanel"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.AlignVerticalCenterWith"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.Below"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.LeftOf"/> XAML attached property.
		/// </summary>
		...
		/// <summary>
		///  Identifies the <see cref="RelativePanel.RightOf"/> XAML attached property.
		/// </summary>

	...
	public class TextBox : System.Windows.Controls.TextBox, ITextBox
	{
		...
		private void ShowPlaceholder()
		{
			if (string.IsNullOrEmpty(base.Text) || base.Text == ((ITextBox)this).Placeholder)
			{
				...
				base.Foreground = new System.Windows.Media.SolidColorBrush(App.Parse(((ITextBox) this).PlaceholderColor));
				IsPlaceHolder = true;
			}
		}
		...
		private void HidePlaceholder()
		{
			...
			{
				base.Text = null;
				base.Foreground = new System.Windows.Media.SolidColorBrush(App.Parse(((ITextBox) this).FontColor));
				IsPlaceHolder = false;
			}
		}

...
namespace OKHOSTING.UI.Net4.WebForms.Controls.Layout
{
	...
	public class RelativePanel: System.Web.UI.WebControls.Panel, IRelativePanel
	{
		...
		public class ControlList : IList<IControl>
		{
			...
			/// <summary>
			/// Initializes a new instance of the "OKHOSTING.UI.Net4.WebForms.Controls.Layout.RelativePanel+ControlList" class.
			/// <para xml:lang="es">Inicializa una nueva instancia de la clase "OKHOSTING.UI.Net4.WebForms.Controls.Layout.RelativePanel+ControlList" class.</para>
			/// </summary>

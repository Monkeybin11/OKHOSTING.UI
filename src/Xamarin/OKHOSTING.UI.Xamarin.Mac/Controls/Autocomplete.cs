...
{
	public class Autocomplete : global::Xamarin.Mac.StackLayout, IAutocomplete
	{
		public Autocomplete()
		{
		...
		protected global::Xamarin.Mac.ListView ResultView;
		protected global::Xamarin.Mac.ContentPage ResultPage;
		...
		public AutocompleteSearchEventArgs OnSearching(string text)
		{
			...
			ResultPage = new global::Xamarin.Mac.ContentPage();
		...
		private void ListView_ItemSelected(object sender, global::Xamarin.Mac.SelectedItemChangedEventArgs e)
		{

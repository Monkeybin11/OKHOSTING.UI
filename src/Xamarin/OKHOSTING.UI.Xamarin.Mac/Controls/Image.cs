...
{
	public class Image : global::Xamarin.Mac.Image, IImage
	{
		void IImage.LoadFromUrl(Uri url)
		{
			base.Source = global::Xamarin.Mac.ImageSource.FromUri(url);
		}

		void IImage.LoadFromFile(string filePath)
		{
			base.Source = global::Xamarin.Mac.ImageSource.FromFile(filePath);
		}

		void IImage.LoadFromStream(Stream stream)
		{
			base.Source = global::Xamarin.Mac.ImageSource.FromStream(() => stream);
		}

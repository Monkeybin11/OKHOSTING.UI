...
namespace OKHOSTING.Streaming.Xamarin.Android
{
	[Service]
    ...
    public class StreamingBackgroundService : Service, AudioManager.IOnAudioFocusChangeListener
    {
		...
		private const string Mp3 = @"http://148.202.165.1:8000/;stream/1";
        ...
        private async void Play()
        {
            ...
            try
			{
                await player.SetDataSourceAsync(ApplicationContext, global::Android.Net.Uri.Parse(Mp3));

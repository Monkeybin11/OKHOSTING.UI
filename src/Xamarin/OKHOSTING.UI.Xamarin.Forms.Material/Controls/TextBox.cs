...
namespace OKHOSTING.UI.Xamarin.Forms.Material.Forms.Controls
{
	...
	/// </para>
	/// </summary>
	public class TextBox : Plugin.MaterialDesignControls.MaterialEntry, ITextBox
	{
		/// <summary>
		...
		{
			ValueChanged?.Invoke(this, base.Text);
		}
		...
		Color ITextBox.PlaceholderColor
		{
			get
			{
				return Xamarin.Forms.Platform.Parse(base.PlaceholderColor);
			}
			set
			{
				base.PlaceholderColor = Xamarin.Forms.Platform.Parse(value);
			}
		}
	}
}